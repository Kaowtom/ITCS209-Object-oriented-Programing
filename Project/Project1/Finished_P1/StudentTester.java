...
public class StudentTester {
	...
	{	
		String customerConfig = "ISSFFIIIAFIAFAIFIIIFIASIISIASSIAFAAFFIFIFF"
				+ "IISSSFSAFSAFIAAAIAFAIISAASSIASAAASFISSSAFASISSIAISFIISIS"
				+ "FFSIFAIISAFSAIISFISASIAFAAAIAIAIIFIFFSAFFASIFFIFIAFFAIFA"
				+ "SIFFFAFAFSAFIFFAIAFSIASSFSAASIAAISSSIAASSIASFA";
	String[][] foodStallConfig = {
			{"Bamboo Shop", "NDMSB"}
			,{"N&B Only", "N"}
			,{"Dessert Only", "D"}
